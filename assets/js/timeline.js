( function( $ ) {
	...
	window.addEventListener("load", UAGBTimeline._scroll)
	window.addEventListener("resize", UAGBTimeline._scroll)
	window.addEventListener("scroll", UAGBTimeline._scroll)
